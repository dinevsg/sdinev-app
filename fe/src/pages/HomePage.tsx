...
// import { OrbitingCircles } from "@/src/components/OrbitingCircle";
// import CertificationCard from "@/src/components/CertificationCard";
// import Icons from "@/src/components/IconsCircle";
// import { cn } from "../../lib/utils";
// import { DotPattern } from "@/src/components/DotPattern";
// import {
//   AnimatedSpan,
//   Terminal,
//   TypingAnimation,
...
// import { TabsBtn, TabsContent, TabsProvider } from '@/src/components/Tabs';
...
//   AccordionItem,
//   AccordionTrigger,
// } from "@/src/components/ProjectsAccordion"
...
//                     <Link href="/projects" className="rounded-2xl w-full sm:w-44 bg-indigo-600 hover:bg-indigo-500  px-7 py-3 text-md font-medium shadow-xl transition">
//                         View my work
//                     </Link>
//                     <Link href="#about" className="rounded-2xl flex justify-center w-full sm:w-44 gap-2 bg-indigo-600/10 hover:bg-indigo-600/50  px-7 py-3 text-md font-medium shadow-xl transition">
//                         More of me
...
//                         <Link href="https://www.linkedin.com/in/sdinev/" target="_blank" className="hover:text-indigo-500 transition">
...
//                         <Link href="https://github.com/dinevsg" target="_blank" className="hover:text-indigo-500 transition">
...
//                         <Link href="http://x.com/dinevsg" target="_blank" className="hover:text-indigo-500 transition">
...
//                     </li>
//                     <li className="box-border relative py-1 pl-0 text-left border-solid">
//                         <Link href="mailto:dinevsg@outlook.com" className="hover:text-indigo-500 transition">
        ...
        <div className="px-6 pt-6 mx-auto box-border flex flex-col items-center content-center leading-6 text-black border-0 border-gray-300 border-solid md:flex-row">
          ...
          <div className="box-border order-first w-full border-solid md:pl-10 md:order-none">
            ...
            <ul className="py-2 flex items-center gap-4 leading-6 text-neutral-main">
              ...
              <li>
                <a href="http://x.com/dinevsg" target="_blank" rel="noopener noreferrer" className="hover:text-indigo-500 transition">
                  <span className="sr-only">X</span>
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-7" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M 2.3671875 3 L 9.4628906 13.140625 L 2.7402344 21 L 5.3808594 21 L 10.644531 14.830078 L 14.960938 21 L 21.871094 21 L 14.449219 10.375 L 20.740234 3 L 18.140625 3 L 13.271484 8.6875 L 9.2988281 3 L 2.3671875 3 z M 6.2070312 5 L 8.2558594 5 L 18.033203 19 L 16.001953 19 L 6.2070312 5 z"></path>
                  </svg>
