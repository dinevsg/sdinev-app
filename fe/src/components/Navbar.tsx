    ...
    <header>
      <nav aria-label="Global" className="container flex max-w-7xl items-center justify-between py-6">
        ...
        <div className="flex lg:hidden">
          ...
          >
            ...
            <IoMenu aria-hidden="true" className="w-6 h-6" />
          </button>
        </div>
      ...
      <Dialog open={mobileMenuOpen} onClose={setMobileMenuOpen} className="lg:hidden">
        <div className="fixed inset-0 z-50">
          <DialogPanel className="fixed inset-x-0 z-10 max-h-screen overflow-y-auto bg-bg/90 border-b border-gray-700 rounded-b-3xl backdrop-blur-sm container px-6 py-6 font-normal text-center flex flex-col">
